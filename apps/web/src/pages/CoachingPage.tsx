...
const KI_MENSCH = [
  ...
  { icon: svg(<><rect x="5" y="11" width="14" height="9" rx="2" /><path d="M8 11V8a4 4 0 0 1 8 0v3" /></>), title: 'Deine Daten gehören dir', text: 'Was du in EchoB dokumentierst, teilst du nur dann, wenn du es möchtest. Kein Coaching-Zugriff ohne deine ausdrückliche Freigabe. Verschlüsselte Speicherung – und wir legen offen, welche Inhalte für die KI-Funktionen verarbeitet werden.' },
]

const badgeIcon = 'h-3.5 w-3.5'
const TRUST_BADGES = [
  { icon: svg(<><rect x="4" y="4" width="16" height="7" rx="1.5" /><rect x="4" y="13" width="16" height="7" rx="1.5" /><path d="M7.5 7.5h.01M7.5 16.5h.01" /></>, badgeIcon), label: 'Verschlüsselt gespeichert' },
  { icon: svg(<><rect x="5" y="11" width="14" height="9" rx="2" /><path d="M8 11V8a4 4 0 0 1 8 0v3" /></>, badgeIcon), label: 'KI-Verarbeitung offengelegt' },
  { icon: svg(<><circle cx="12" cy="12" r="8.5" /><path d="M6 6l12 12" /></>, badgeIcon), label: 'Kein Training mit deinen Daten' },
