...
export default function BlogKrisentelephonePage() {
  return (
    <PageLayout>
      <BlogArticleLayout
        tag="Soforthilfe"
        ...
        echoLink="/app?blog=blog_krisentelefone"
      ...
      >
        ...
        <h3>Nummer gegen Kummer (Kinder & Jugendliche)</h3>
        <ul>
          <li><strong>116 111</strong> – kostenlos, Mo–Sa 14–20 Uhr</li>
          <li>Online unter: nummergegenkummer.de</li>
        </ul>

        <h3>Weißer Ring</h3>
        <ul>
          <li><strong>116 006</strong> – Opfertelefon, kostenlos, Mo–So 7–22 Uhr</li>
          <li>Für Opfer von Straftaten: weisser-ring.de</li>
        </ul>

        <h3>Beratungsstellen</h3>
        <ul>
          <li><strong>beratungsstellen.de</strong> – Suchportal für psychosoziale Beratung</li>
          <li><strong>caritas.de</strong> / <strong>diakonie.de</strong> – Beratung nach Lebenslagen</li>
          <li>Frauenhäuser: frauenhauskoordinierung.de</li>
        </ul>
        ...
        <ul>
          ...
          <li><strong>147</strong> – Rat auf Draht (Kinder & Jugendliche), kostenlos, 24/7</li>
        ...
        <ul>
          ...
          <li><strong>147</strong> – Pro Juventute Beratung (Kinder & Jugendliche), 24/7</li>
        ...
        <p>
          ...
          nichts verpflichten. Du kannst auch einfach zuhören, wenn du nicht weißt, was du sagen sollst.
        </p>
        <p>
