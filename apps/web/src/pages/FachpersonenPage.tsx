    ...
    <PageLayout>
      ...
      <section className="border-t border-brand-border bg-navy/[0.02] px-6 py-[72px]">
        <div className="mx-auto max-w-[960px]">
          ...
          {/* Ausbildungsinstitute — dezenter Verweis (Fachpersonen-Vermarktung bleibt primär) */}
          <Reveal delay={0.1}>
            <div className="mt-6 flex flex-wrap items-center justify-between gap-3 rounded-[1rem] border border-brand-border bg-navy/[0.02] px-5 py-4">
              <p className="text-sm text-brand-muted">
                <span className="font-semibold text-navy">Ausbildungsinstitut?</span> EchoB gibt es auch als Lizenz für die Lehre –
                Ihre Studierenden üben am selben, sicheren Fallmaterial.
              </p>
              <Link to="/ausbildungsinstitute" className="shrink-0 text-sm font-semibold text-accent no-underline hover:underline">
                So funktioniert's →
              </Link>
            </div>
          </Reveal>
