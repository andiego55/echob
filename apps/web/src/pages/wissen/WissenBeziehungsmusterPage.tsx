...
export default function WissenBeziehungsmusterPage() {
  return (
    <PageLayout>
      <BlogArticleLayout
        ...
        echoLink="/app?wissen=beziehungsmuster"
      ...
      >
        ...
        <p>
          ...
          vor der aktuellen Beziehung. Frühe Bindungserfahrungen prägen grundlegende Erwartungen: Ist Nähe sicher?
          Wird Bedürftigkeit bestraft? Muss ich kämpfen, um gesehen zu werden?
        </p>
        <p>
          Diese inneren Überzeugungen aktivieren sich in engen Beziehungen automatisch. Wenn ein aktuelles
          Verhalten an alte Verletzungen erinnert, reagiert das Nervensystem, als ob die alte Situation
          noch andauert.
        </p>
        ...
        <p>
          ...
          Muster sind Verhaltensbeschreibungen, keine Charakterurteile. Auch die eigenen.
        </p>
        <p>
