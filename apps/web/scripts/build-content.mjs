...
const CLUSTERS = ['dynamiken', 'vertrauensbruch', 'emotionaler-missbrauch', 'grenzverletzung', 'gaslighting', 'narzissmus', 'narzissmus-spielarten', 'emotionale-unreife', 'borderline', 'neurodivergenz', 'trauma', 'kodependenz', 'sucht', 'bindung', 'trennung', 'trennung-mit-kindern', 'liebeskummer', 'selbstmitgefuehl', 'selbsterkenntnis', 'selbstreflexion', 'paartherapie', 'therapie', 'kommunikation', 'liebessprachen', 'sexualitaet', 'grenzen', 'konflikt', 'mental-load', 'gefuehle']
