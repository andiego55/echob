...
const CLUSTERS = ['dynamiken', 'emotionaler-missbrauch', 'gaslighting', 'narzissmus', 'narzissmus-spielarten', 'trauma', 'kodependenz', 'bindung', 'trennung', 'liebeskummer', 'selbstreflexion', 'therapie', 'kommunikation', 'liebessprachen', 'grenzen', 'konflikt', 'gefuehle']
