...
const CLUSTERS = ['dynamiken', 'vertrauensbruch', 'emotionaler-missbrauch', 'grenzverletzung', 'gaslighting', 'narzissmus', 'narzissmus-spielarten', 'trauma', 'kodependenz', 'bindung', 'trennung', 'liebeskummer', 'selbstmitgefuehl', 'selbsterkenntnis', 'selbstreflexion', 'paartherapie', 'therapie', 'kommunikation', 'liebessprachen', 'grenzen', 'konflikt', 'gefuehle']
