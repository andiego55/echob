...
const CLUSTERS = ['dynamiken', 'vertrauensbruch', 'emotionaler-missbrauch', 'grenzverletzung', 'gaslighting', 'narzissmus', 'narzissmus-spielarten', 'emotionale-unreife', 'trauma', 'kodependenz', 'bindung', 'trennung', 'liebeskummer', 'selbstmitgefuehl', 'selbsterkenntnis', 'selbstreflexion', 'paartherapie', 'therapie', 'kommunikation', 'liebessprachen', 'grenzen', 'konflikt', 'gefuehle']
