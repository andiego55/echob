...
const CLUSTERS = ['dynamiken', 'emotionaler-missbrauch', 'gaslighting', 'narzissmus', 'narzissmus-spielarten', 'trauma', 'bindung', 'trennung', 'liebeskummer', 'selbstreflexion', 'therapie', 'kommunikation', 'grenzen', 'konflikt', 'gefuehle']
